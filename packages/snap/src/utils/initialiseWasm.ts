import type { InitOutput } from '@zcashcommunitygrants/webzjs-keys';
import { initSync } from '@zcashcommunitygrants/webzjs-keys';
import wasmDataBase64 from '@zcashcommunitygrants/webzjs-keys/webzjs_keys_bg.wasm';
